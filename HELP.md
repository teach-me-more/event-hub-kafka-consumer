...
* The original package name 'com.rbasystems.kafka.eventhub.event-hub-kafka-consumer' is invalid and this project uses 'com.rbasystems.kafka.eventhub.event_hub_kafka_consumer' instead.
